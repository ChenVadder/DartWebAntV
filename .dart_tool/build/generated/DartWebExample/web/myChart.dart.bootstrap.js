...
let modulePaths = {
 ...
 "web/myChart": "myChart.sound.ddc"
};
if(!window.$dartLoader) {
   window.$dartLoader = {
     appDigests: _currentDirectory + 'myChart.digests',
...
define("myChart.dart.bootstrap", ["web/myChart", "dart_sdk"], function(app, dart_sdk) {
  ...
  (app.web__myChart || app.myChart).main();
  var bootstrap = {
  ...
  dart_sdk.dart.trackLibraries("myChart.dart.bootstrap", {
    "myChart.dart.bootstrap": bootstrap
  }, '');
  return {
    bootstrap: bootstrap
  };
